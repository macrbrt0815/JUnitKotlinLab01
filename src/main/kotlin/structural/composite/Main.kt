...
fun main(args: Array<String>) {
    ...
    println(employeeDirectory.totalEmployee())
    println(supervisorDirectory.totalEmployee())
    println(managerDirectory.totalEmployee())
    println(companyDirectory.totalEmployee())
}